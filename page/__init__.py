...
#
# """注册页面"""
# # sign_in_exist_account_id = By.ID,'com.yunmall.lc:id/textViewl'
# sign_in_exist_account_id = By.ID, "com.yunmall.lc:id/gotologon"
#
# """登录页面"""
...
# setting_center_login_dialog_confim_btn = By.ID, 'com.yunmall.lc:id/ymtitlebar_right_button'
from selenium.webdriver.common.by import By
"""
首页
"""
...
注册页面
"""
# sign_in_exist_account_id = By.ID,"com.yunmall.lc:id/textView1"
sign_in_exist_account_id = By.ID,"com.yunmall.lc:id/gotologon"
